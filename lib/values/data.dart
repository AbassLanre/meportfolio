...
class Data {
  ...
  static List<ProjectCategoryData> projectCategories = [
    ...
    ProjectCategoryData(title: StringConst.E_COMMERCE, number: 1),
    ProjectCategoryData(title: StringConst.GENERAL, number: 1),
  ];
  ...
  static List<NimBusCardData> nimbusCardData = [
    NimBusCardData(
      title: StringConst.FLUTTER_DEV,
      subtitle: StringConst.FLUTTER_DEV_DESC,
  ...
  static List<ProjectData> allProjects = [
    ProjectData(
      ...
      category: StringConst.E_COMMERCE,
  ...
  static List<ProjectData> ecommerce = [
    ProjectData(
      title: StringConst.PORTFOLIO_2_TITLE,
      category: StringConst.E_COMMERCE,
      projectCoverUrl: ImagePath.PORTFOLIO_8,
  ...
  static List<ProjectData> general = [
    ProjectData(
      title: StringConst.PORTFOLIO_1_TITLE,
      category: StringConst.GENERAL,
      projectCoverUrl: ImagePath.PORTFOLIO_7,
