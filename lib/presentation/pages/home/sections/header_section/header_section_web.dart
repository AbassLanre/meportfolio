...
import 'package:meportfolio/presentation/pages/home/sections/header_section/widgets.dart';
import 'package:meportfolio/presentation/widgets/buttons/nimbus_button.dart';
import 'package:meportfolio/presentation/widgets/content_area.dart';
                              ...
                              Row(
                                children: [
                                  NimbusButton(
                                    ...
                                    onPressed: () async{
                                      if (!await launchUrl(Uri.parse('https://drive.google.com/file/d/15ed5c4L-_dGtZmzW9MOQNCOraN5SgaBn/view?usp=sharing'))) {
