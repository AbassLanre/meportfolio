...
class _ProjectItemState extends State<ProjectItem>
  ...
  gotoProjectStore(String url) async {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        print(widget.title);
        widget.title == 'Power Calculator'
            ? gotoProjectStore(
                'https://play.google.com/store/apps/details?id=com.abassapp.power_calc')
            : gotoProjectStore(
                'https://play.google.com/store/apps/details?id=com.courierx');
      },
      child: MouseRegion(
